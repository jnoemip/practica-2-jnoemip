...
mlflow.set_tracking_uri("http://127.0.0.1:9090") # cambiar en función de su servidor
model = mlflow.sklearn.load_model("models:/modelo_pipeline/2") # cambiar en función de su modelo
